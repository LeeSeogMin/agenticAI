# 대중 교재 작성 시스템 (강의계획서 기반)

AI 에이전트 기반으로 강의계획서를 “자가 학습 가능한 대중 교재(텍스트북)”로 재구성해 집필하는 템플릿입니다.

## 개요

이 시스템은 6개의 전문 에이전트가 협력하여 고품질 교재를 작성하는 워크플로우를 제공합니다.
...
### 1. 교재 목차 설정
`contents.md`에서 교재의 목차와 장별 집필 방향을 정의합니다. 강의계획서 원문은 `content/sources/syllabus.md`에 보관합니다.
