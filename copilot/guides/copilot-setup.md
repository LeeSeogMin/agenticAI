...
1. https://github.com/settings/copilot 이동
2. "Code, planning, and automation" → Copilot 클릭
3. 학생 혜택으로 무료 가입 버튼 클릭

**방법 B**:

1. https://github.com/features/copilot 이동
...
| **형태** | `.github/skills/` 폴더 내 [SKILL.md](http://skill.md/) | MCP 서버 실행 |
...
| --- | --- | --- |
| **pandas-eda-standard** | "eda", "explore", "summary" | [df.info](http://df.info/)(), describe(), 결측치 처리, 분포 시각화 |
...
1. VS Code 재시작 또는 Reload Window (Ctrl+R)
2. Copilot Chat에서 "이 데이터 EDA 해줘"라고 요청하면 자동 적용!
...
- Copilot 설정: https://github.com/settings/copilot
- MCP 서버 Registry: https://github.com/modelcontextprotocol/servers
- Copilot 공식 문서: https://docs.github.com/ko/copilot
