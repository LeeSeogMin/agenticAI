...
- 이 강의: GitHub Copilot의 Agent Mode, MCP, Skills를 활용하여 실제 동작하는 AI 에이전트를 만드는 실습 중심 과정
- `docs/`의 12장 교재가 이론과 프레임워크 비교에 초점을 둔다면, 이 강의는 **"지금 바로 만들어 본다"**에 집중
